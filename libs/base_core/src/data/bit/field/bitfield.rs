// devela_base_core::data::bit::field::bitfield
//
...
#[doc = crate::doclink!(devela "[bitfield]" "_info/examples/bitfield" @mod)]
/// ```
/// # use devela_base_core::bitfield;
/// bitfield! {
...
#[doc = crate::doclink!(devela "[`enumset!`]" "code/util/macro.enumset.html")]
#[doc(hidden)]
#[macro_export]
