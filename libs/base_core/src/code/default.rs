...
macro_rules! impl_cdef {
    ...
    (%$seal:ident%: $($t:ty),+ $(,)?) => { $( $crate::impl_cdef![%$seal%:@$t]; )+ };
    ...
    (%$seal:ident% $trait:ident: arrays <$A:ident:$BOUND:ident> $($LEN:literal),+) => {
        $( $crate::impl_cdef![%$seal% $trait:@array:$LEN <$A:$BOUND>]; )+
    };
    ...
    (%$seal:ident% $trait:ident: tuples <$A:ident:$BOUND:ident>) => {
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,) => // 1
            ($A::DEFAULT,)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,) => // 2
            ($A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A) => // 3
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A) => // 4
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A) => // 5
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A,$A) => // 6
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A,$A,$A) => // 7
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT,
             $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A,$A,$A,$A) => // 8
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT,
             $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A,$A,$A,$A,$A) => // 9
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT,
             $A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A,$A,$A,$A,$A,$A)
            => // 10
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT,
             $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A,$A,$A,$A,$A,$A,$A)
            => // 11
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT,
             $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
        $crate::impl_cdef![%$seal%$trait:@tuple <$A:$BOUND> ($A,$A,$A,$A,$A,$A,$A,$A,$A,$A,$A,$A)
            => // 12
            ($A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT,
             $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT, $A::DEFAULT)];
    };
