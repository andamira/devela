...
#[allow(unused)]
const CRATE_NAME: &str = "devela_base_data";
...
fn try_main() -> Result<(), Box<dyn core::error::Error>> {
    #[cfg(feature = "__dbg")]
    Build::println_start_end("base_data build script", true);
    ...
    #[cfg(feature = "__dbg")]
    Build::println_start_end("base_data build script", false);
    Ok(())
}
