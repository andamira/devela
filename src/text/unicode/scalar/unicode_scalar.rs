...
///
#[doc = crate::_doc_meta!{location("text/unicode/scalar", trait UnicodeScalar)}]
///
/// It's implemented for: [`char`][crate::char],
/// [`char7`], [`char8`], [`char16`], [`charu`] and [`charu_niche`];
pub trait UnicodeScalar {
    ...
    fn as_ascii_translit(self) -> &'static str where Self: Sized {
        crate::Translit::ascii_scalar(self.to_scalar())
    }
