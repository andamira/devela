// devela/src/text/unicode/scalar/namespace/define.rs
//
...
///   Rust's [`char`][prim@char] represents exactly this set.
...
///   - [random_next](#method.random_next).
///   - [random_from_seed](#method.random_from_seed).
///
...
///   - [scalar_from_rank](#method.scalar_from_rank).
///   - [scalar_rank](#method.scalar_rank).
...
///   - [is_ascii](#method.is_ascii-1) ([*unchecked*](#method.as_ascii_unchecked-1)).
...
///   - [to_utf8_bytes](#method.to_utf8_bytes-1) ([*unchecked*](#method.to_utf8_bytes_unchecked)).
