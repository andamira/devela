...
impl_IntBufAble!(ranges:
    ...
    U16_MAX_LEN => NonRangeU16(u16),
    I32_MAX_LEN => NonRangeI32(i32),
    U32_MAX_LEN => NonRangeU32(u32),
...
#[cfg(all(feature = "num", target_pointer_width = "16"))]
impl_IntBufAble!(ranges:
