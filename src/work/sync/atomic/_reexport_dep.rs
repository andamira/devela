// devela/src/work/sync/atomic/_reexport_dep.rs
//
...
_reexport! { "dep_portable_atomic", "portable-atomic", portable_atomic,
    location: "work/sync/atomic" => struct AtomicF32,
    tag: _tags!(concurrency atomic),
    doc: "A thread-safe floating-point type.",
    AtomicF32,
}
_reexport! { "dep_portable_atomic", "portable-atomic", portable_atomic,
    location: "work/sync/atomic" => struct AtomicF64,
    tag: _tags!(concurrency atomic),
    doc: "A thread-safe floating-point type.",
    AtomicF64
}
...
mod impl_const_init_for_atomic {
    ...
    _impl_init![<T: ConstInit> Self::new(T::INIT) => super::Atomic<T>];
}
#[cfg(feature = "dep_portable_atomic")]
mod impl_const_init_for_portable_atomic {
    ...
    _impl_init![Self::new(f32::INIT) => super::AtomicF32];
    _impl_init![Self::new(f64::INIT) => super::AtomicF64];

    // with core alternatives:
    _impl_init![Self::new(i8::INIT) => super::AtomicI8];
    _impl_init![Self::new(u8::INIT) => super::AtomicU8];
    _impl_init![Self::new(i16::INIT) => super::AtomicI16];
    _impl_init![Self::new(u16::INIT) => super::AtomicU16];
    _impl_init![Self::new(i32::INIT) => super::AtomicI32];
    _impl_init![Self::new(u32::INIT) => super::AtomicU32];
    _impl_init![Self::new(i64::INIT) => super::AtomicI64];
    _impl_init![Self::new(u64::INIT) => super::AtomicU64];
    _impl_init![Self::new(i128::INIT) => super::AtomicI128];
    _impl_init![Self::new(u128::INIT) => super::AtomicU128];
    _impl_init![Self::new(isize::INIT) => super::AtomicIsize];
    _impl_init![Self::new(usize::INIT) => super::AtomicUsize];
    _impl_init![<T> Self::new(<*mut T>::INIT) => super::AtomicPtr<T>];
}
#[cfg(not(feature = "dep_portable_atomic"))]
