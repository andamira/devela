...
macro_rules! impl_ops {
    ...
    (@signed $t:ty) => { paste! {
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_proper_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_prime_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_prime_unique_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_" $t "_buf;\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_proper_" $t "_buf;\n\n"]
        /// let (mut fbuf, mut upbuf) = ([0; 20], [0; 20]);
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_prime_" $t "_buf;\n\n"]
        /// let mut buf = [0; 5];
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_prime_unique_" $t "_buf;\n\n"]
        /// let mut uniq = [0; 5];
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::factors_prime_unique_plus_" $t "_buf;\n\n"]
