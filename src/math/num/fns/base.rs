...
macro_rules! impl_ops {
    ...
    (@signed $t:ty) => { paste! {
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::num::count_digits_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::num::count_digits_sign_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::num::count_digits_base_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::num::count_digits_base_sign_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::num::digital_root_" $t ";\n\n"]
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::math::num::digital_root_base_" $t ";\n\n"]
