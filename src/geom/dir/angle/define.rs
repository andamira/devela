...
#[doc = crate::_doc_meta!{
    location("geom/dir", struct Angle),
    test_size_of(Angle<f32> = 4|32; niche !Option),
}]
...
#[doc = crate::_doc_meta!{
    location("geom/dir", enum AngleDirection),
    test_size_of(AngleDirection = 1|8; niche Option),
}]
...
impl AngleDirection {
    ...
    pub const LeftHandRule: AngleDirection = AngleDirection::Negative;
    pub const LHR: AngleDirection = AngleDirection::Negative;
}
