...
#[doc = crate::doclink!(custom devela "[vendored work]" "_doc/reference/vendored" @mod)]
///
...
macro_rules! _doc_vendor· {
    ...
    //     $crate_id, "][crate::_doc::reference::vendored::", $mod_id, "].\n\n"
    // )};

    (
    // Assumes the path is in current directory. Used in `_doc/reference/vendored`.
    //
    // $crate_id:  the crate's name and html id anchor on the docs.
