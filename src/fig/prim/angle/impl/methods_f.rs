// devela::fig::prim::angle::impl::methods_f
//
//!
//
...
macro_rules! impl_angle {
    ...
    (@float $f:ty : $cap:literal) => {
        ...
        impl Angle<$f> {
            ...
            /// # Features
            /// This function will only be const with the `unsafe_const` feature enabled.
            #[inline] #[must_use] #[cfg(all(not(feature = "safe_fig"), feature = "unsafe_const"))]
            ...
            /// features enabled.
            #[inline] #[cfg(all(
                not(feature = "safe_fig"), feature = "unsafe_const", feature = "num_float"
            ))]
