...
items! { macro_rules! _ARCH {()=>{"x86_64"}} pub(crate) use _ARCH; }
#[cfg(target_arch = "x86")]
items! { macro_rules! _ARCH {()=>{"x86"}} pub(crate) use _ARCH; }
#[cfg(target_arch = "arm")]
items! { macro_rules! _ARCH {()=>{"arm"}} pub(crate) use _ARCH; }
#[cfg(target_arch = "aarch64")]
items! { macro_rules! _ARCH {()=>{"aarch64"}} pub(crate) use _ARCH; }
