...
crate::mods_in! {
    ...
    pub mod_ alloc; // Memory allocation, arenas, and ownership-backed storage.
    pub mod_ bound; // Addressing, alignment, and movement constraints over memory.
    pub mod_ cell; // ExtCellOption, ::core::cell::*
    pub mod_ layout; // Memory layout, bit-validity, and representation invariants.
    pub mod_ size; // size_of_expr!, BitSized, ByteSized,
    pub mod_ view; // Typed and byte-level views over memory.
}
