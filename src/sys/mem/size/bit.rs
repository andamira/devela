...
// NOTE: NonValue* types have their implementation in /src/num/grain/niche/impls.rs
...
_impl_bit_sized![array = 24 * len for T: 24 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 32 * len for T: 32 * len: 1, 2, 4, 8, 16];
_impl_bit_sized![array = 40 * len for T: 40 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 48 * len for T: 48 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 56 * len for T: 56 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 64 * len for T: 64 * len: 1, 2, 4, 8, 16];
_impl_bit_sized![array = 72 * len for T: 72 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 80 * len for T: 80 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 88 * len for T: 88 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 96 * len for T: 96 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 104 * len for T: 104 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 112 * len for T: 112 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 120 * len for T: 120 * len: 1, 2, 4, 8, 16]; // *
_impl_bit_sized![array = 128 * len for T: 128 * len: 1, 2, 4, 8, 16];
...
crate::items! {
    ...
    _impl_bit_sized![= 24; for AnsiColor]; // NOTE: 24 as union, 32 with discriminant
}
