...
global_asm! {
    ".global __linux_restore_rt",
    ".hidden __linux_restore_rt",
    ".type __linux_restore_rt,@function",
    "__linux_restore_rt:",
        "mov rax, {RT_SIGRETURN}",
        "syscall",
    // ".size __linux_restore_rt,.-__linux_restore_rt",
...
#[cfg(target_arch = "x86")]
global_asm!(
    ".global __linux_restore",
    ".hidden __linux_restore",
    ".type __linux_restore,@function",
    "__linux_restore:",
        "popl eax",
        "movl eax, {SIGRETURN}",
        "int 0x80",
    // ".size __linux_restore,.-__linux_restore",
