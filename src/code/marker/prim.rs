...
#[doc = crate::_doc_meta!{location("code/marker", trait Prim)}]
///
...
#[doc = crate::_doc_meta!{location("code/marker", trait PrimFitPtr)}]
...
#[doc = crate::_doc_meta!{location("code/marker", trait PrimIndex)}]
...
#[doc = crate::_doc_meta!{location("code/marker", trait IndexRepr)}]
///
