...
#[doc = crate::_doc_meta!{location("code/result", trait Hook)}]
///
...
#[doc = crate::_doc_meta!{location("code/result", macro hook)}]
///
...
#[doc = crate::_doc_meta!{location("code/result", trait Morph)}]
///
...
#[doc = crate::_doc_meta!{location("code/result", macro morph)}]
///
