...
macro_rules! primitive_float_const_cmp {
    ...
    (@$b:literal >> $sh:literal) => { paste! {
        ...
        ///
        /// # Features
        /// This function will only be `const` if the `unsafe_num` feature is enabled.
        #[inline]
        #[must_use]
