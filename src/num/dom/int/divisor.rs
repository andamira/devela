...
divisor! {
    ...
    /// An example divisor helper generated by [`divisor!`].
    #[doc = crate::_doc_meta!{
...
#[doc = crate::_doc_meta!{
    location("num/dom/int", struct DivisorInner),
}]
#[derive(Clone, Copy)]
...
macro_rules! divisor· {
    ...
    // supported representations
     %impl $Type:ty, $Name:ident; u8) => {
        $crate::divisor!(%impl_u $Type,$Name; u8|u16:Y); };
    (%impl $Type:ty,$Name:ident; u16) => {
        $crate::divisor!(%impl_u $Type,$Name; u16|u32:Y); };
    (%impl $Type:ty,$Name:ident; u32) => {
        $crate::divisor!(%impl_u $Type,$Name; u32|u64:Y); };
    (%impl $Type:ty,$Name:ident; u64) => {
        $crate::divisor!(%impl_u $Type,$Name; u64|u128:PW); };
    (%impl $Type:ty,$Name:ident; u128) => {
        $crate::divisor!(%impl_u $Type,$Name; u128|u128:N); };
    (%impl $Type:ty,$Name:ident; usize) => {
        $crate::divisor!(%impl_u $Type,$Name; usize|$crate::usize_up:Y); };
    (%impl $Type:ty,$Name:ident; i8) => {
        $crate::divisor!(%impl_i $Type,$Name; i8|u8|i16|u16:Y); };
    (%impl $Type:ty,$Name:ident; i16) => {
        $crate::divisor!(%impl_i $Type,$Name; i16|u16|i32|u32:Y); };
    (%impl $Type:ty,$Name:ident; i32) => {
        $crate::divisor!(%impl_i $Type,$Name; i32|u32|i64|u64:Y); };
    (%impl $Type:ty,$Name:ident; i64) => {
        $crate::divisor!(%impl_i $Type,$Name; i64|u64|i128|u128:PW); };
    (%impl $Type:ty,$Name:ident; i128) => {
        $crate::divisor!(%impl_i $Type,$Name; i128|u128|i128|u128:N); };
    (%impl $Type:ty,$Name:ident; isize) => {
        $crate::divisor!(%impl_i $Type,$Name;
    ...
    (// specific implementations
     %impl_i $Type:ty, $Name:ident; $t:ty | $un:ty | $up:ty | $unup:ty : $is_up:ident) => {
        divisor![%traits $Type, $Name; $t]; // utility traits

        impl $Type {
            divisor![%shared $Type,$Name; $t|$un|$up|$unup:$is_up]; // shared methods
    ...
    (%impl_u $Type:ty, $Name:ident; $t:ty | $up:ty : $is_up:ident) => {
        ...
        impl $Type {
            divisor![%shared $Type, $Name; $t|$t|$up|$up:$is_up]; // shared methods
