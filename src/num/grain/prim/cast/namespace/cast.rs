...
//
// TOC
// - _impl_cast_inner_fns!
// - _impl_cast_casting_fns!
// - _impl_cast_methods!
...
macro_rules! _impl_cast_inner_fns {
    () => {
        /* independent of pointer width */

        _impl_cast_inner_fns![can_overunderflow
        ...
        _impl_cast_inner_fns![can_overflow
        ...
        _impl_cast_inner_fns![can_underflow
        ...
        _impl_cast_inner_fns![cant_fail
        ...
        #[cfg(target_pointer_width = "16")]
        _impl_cast_inner_fns![cant_fail ptr:16
            // from smaller unsigned to unsigned
        ...
        #[cfg(target_pointer_width = "32")]
        _impl_cast_inner_fns![cant_fail ptr:32
            // from smaller unsigned to unsigned
        ...
        #[cfg(target_pointer_width = "64")]
        _impl_cast_inner_fns![cant_fail ptr:64
            // from smaller unsigned to unsigned
            usize:u128,
    ...
    (can_overunderflow $( $f:ty : $t:ty ),+) => {
        $( _impl_cast_inner_fns![@can_overunderflow $f:$t]; )+
    };
    ...
    (can_overflow $( $f:ty:$t:ty ),+) => {
        $( _impl_cast_inner_fns![@can_overflow $f:$t]; )+
    };
    ...
    (can_underflow $( $f:ty:$t:ty ),+) => {
        $( _impl_cast_inner_fns![@can_underflow $f:$t]; )+
    };
    ...
    (cant_fail $( $f:ty:$t:ty ),+) => {
        $( _impl_cast_inner_fns![@cant_fail $f:$t]; )+
    };
    ...
    (cant_fail ptr:$ptr:literal $( $f:ty:$t:ty ),+) => {
        $( _impl_cast_inner_fns![@cant_fail ptr:$ptr $f:$t]; )+
    };
...
macro_rules! _impl_cast_casting_fns {
    () => {
        #[cfg(target_pointer_width = "16")] _impl_cast_casting_fns![@to isize_up|i32];
        #[cfg(target_pointer_width = "16")] _impl_cast_casting_fns![@to usize_up|u32];
        #[cfg(target_pointer_width = "16")] _impl_cast_casting_fns![@to isize_down|i8];
        #[cfg(target_pointer_width = "16")] _impl_cast_casting_fns![@to usize_down|u8];
        //
        #[cfg(target_pointer_width = "32")] _impl_cast_casting_fns![@to isize_up|i64];
        #[cfg(target_pointer_width = "32")] _impl_cast_casting_fns![@to usize_up|u64];
        #[cfg(target_pointer_width = "32")] _impl_cast_casting_fns![@to isize_down|i16];
        #[cfg(target_pointer_width = "32")] _impl_cast_casting_fns![@to usize_down|u16];
        //
        #[cfg(target_pointer_width = "64")] _impl_cast_casting_fns![@to isize_up|i128];
        #[cfg(target_pointer_width = "64")] _impl_cast_casting_fns![@to usize_up|u128];
        #[cfg(target_pointer_width = "64")] _impl_cast_casting_fns![@to isize_down|i32];
        #[cfg(target_pointer_width = "64")] _impl_cast_casting_fns![@to usize_down|u32];
    };
    (@to $a:ident|$t:ty) => {
        _impl_cast_casting_fns![@to $a|$t:
            i8, u8, i16, u16, i32, u32, i64, u64, i128, u128, isize, usize];
    };
    (@to $a:ident|$t:ty : $($f:ty),+) => { $( _impl_cast_casting_fns!(@impl $f, $a, $t);)+ };
...
macro_rules! _impl_cast_methods {
    () => {
        _impl_cast_methods![u8, u16, u32, u64, u128, usize, i8, i16, i32, i64, i128, isize];
    };
    ($($t:ty),+) => { $( _impl_cast_methods![@$t]; )+ };
    (@$t:ty) => { paste! {
