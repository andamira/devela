...
macro_rules! __bound_int_impl_signed {
    (
        ...
        $crate::__bound_int_impl_signed!(%ops $Name; $Carrier; $Unsigned; $Up; $Range; $($op),*);
    };

    /* op group validation */

    (%ops $Name:ident; $Carrier:ty; $Unsigned:ty; $Up:ty; $Range:ident;) => {};
    // NOTE: mixing aliases is not supported
    // FUTURE: make the parser a state-machine to use accummulated flags
    (%ops $Name:ident; $Carrier:ty; $Unsigned:ty; $Up:ty; $Range:ident; all) => {
        $crate::__bound_int_impl_signed!(%ops $Name; $Carrier; $Unsigned; $Up; $Range; sat, che, mod, up);
    };
    (%ops $Name:ident; $Carrier:ty; $Unsigned:ty; $Up:ty; $Range:ident; default) => {
        $crate::__bound_int_impl_signed!(%ops $Name; $Carrier; $Unsigned; $Up; $Range; sat, che);
    };
    (%ops $Name:ident; $Carrier:ty; $Unsigned:ty; $Up:ty; $Range:ident; sat $(, $rest:ident)*) => {
        impl $Name {
            /* sign */
            ...
            pub const fn abs(self) -> Self { Self::from_abs_carrier(self.get().abs()) }
        ...
        $crate::__bound_int_impl_signed!(%ops $Name; $Carrier; $Unsigned; $Up; $Range; $($rest),*);
    };
    (%ops $Name:ident; $Carrier:ty; $Unsigned:ty; $Up:ty; $Range:ident; che $(, $rest:ident)*) => {
        /// # Checked operations
        impl $Name {
            /* arithmetic */
    ...
    (%ops $Name:ident; $Carrier:ty; $Unsigned:ty; $Up:ty; $Range:ident; mod $(, $rest:ident)*) => {
        /// # Modular operations
        impl $Name {
            /* arithmetic */
    ...
    (%ops $Name:ident; $Carrier:ty; $Unsigned:ty; $Up:ty; $Range:ident; up $(, $rest:ident)*) => {
