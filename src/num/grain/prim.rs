...
#[doc = crate::_doc_meta!{location("num/grain", trait PrimScalar)}]
...
#[doc = crate::_doc_meta!{location("num/grain", trait PrimInt)}]
...
#[doc = crate::_doc_meta!{location("num/grain", trait PrimSint)}]
...
#[doc = crate::_doc_meta!{location("num/grain", trait PrimUint)}]
...
#[doc = crate::_doc_meta!{location("num/grain", trait PrimFloat)}]
