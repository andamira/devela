...
crate::__impl_dep_rand_core!(XorShift32
    <const BASIS: usize, const A: usize, const B: usize, const C: usize>);

#[doc = crate::_tags!(rand)]
/// 81 × good triplets for 32-bit xorshift. (243 Bytes)
#[doc = crate::_doc_meta!{
    location("num/prob/rand", const XOROSHIFT_32_TRIPLETS),
}]
#[doc(hidden)]
#[rustfmt::skip]
#[allow(dead_code)]
