...
use crate::{
    code::{iif, paste},
    num::{fsize, FloatOps, NumErrors, NumResult as Result},
};
...
macro_rules! impl_ops {
    ...
    (@signed($t:ty, $up:ty, $ft:ty) ) => { paste! {
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::num::prime_is_" $t ";\n\n"]
        ...
        ///
        #[doc = "Returns [`NumErrors::Overflow`] if the result would not fit in an `" $t "`."]
        ///
        /// # Examples
        /// ```
        #[doc ="use devela::num::prime_nth_" $t ";\n\n"]
        #[doc = "assert_eq![Ok(2), prime_nth_" $t "(0)];"]
        #[doc = "assert_eq![Ok(3), prime_nth_" $t "(1)];"]
        #[doc = "assert_eq![Ok(127), prime_nth_" $t "(30)];"]
        #[doc = "assert_eq![Ok(127), prime_nth_" $t "(-30)];"]
        /// assert![devela::num::prime_nth_i8(121).is_err()];
        /// ```
        #[inline]
        pub fn [<prime_nth_ $t>](nth: $t) -> Result<$t> {
            ...
            loop {
                ...
                i = i.checked_add(1).ok_or(NumErrors::Overflow)?;
            }
        }
        ...
        /// # Examples
        /// ```
        #[doc ="use devela::num::prime_pi_" $t ";\n\n"]
    ...
    (@unsigned($t:ty, $up:ty, $ft:ty) ) => { paste! {
        ...
        /// Finds the 0-indexed `nth` prime number.
        ///
        #[doc = "Returns [`NumErrors::Overflow`] if the result would not fit in a `" $t "`."]
        ///
        /// # Examples
        /// ```
        #[doc ="use devela::num::prime_nth_" $t ";\n\n"]
        ...
        /// assert![devela::num::prime_nth_u8(253).is_err()];
        /// ```
        #[inline]
        pub fn [<prime_nth_ $t>](nth: $t) -> Result<$t> {
