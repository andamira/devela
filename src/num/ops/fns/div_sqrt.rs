...
macro_rules! impl_ops {
    ...
    (@signed $t:ty ) => { paste! {
        ...
        /// # Examples
        /// ```
        #[doc = "use devela::num::div_ties_away_" $t ";"]
        ...
        /// # Examples
        /// ```
        #[doc = "use devela::num::div_ties_towards_" $t ";"]
        ...
        /// # Examples
        /// ```
        #[doc = "use devela::num::div_ties_even_" $t ";"]
        ...
        /// # Examples
        /// ```
        #[doc = "use devela::num::div_ties_odd_" $t ";"]
