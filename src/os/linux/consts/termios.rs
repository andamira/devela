// devela::os::linux::consts::termios
//
//! linux [`termios`] flags
//!
...
impl LINUX_TERMIOS_OFLAG {
    ...
    pub const NLDLY: c_uint = 0000400;
    /// `NLDLY`: Newline type 0.
    pub const NL0: c_uint = 0000000;
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE` or `_XOPEN_SOURCE`]
    pub const CRDLY: c_uint = 0003000;
    /// `CRDLY`: Carriage-return delay type 0.
    pub const CR0: c_uint = 0000000;
    /// `CRDLY`: Carriage-return delay type 1.
    pub const CR1: c_uint = 0001000;
    /// `CRDLY`: Carriage-return delay type 2.
    pub const CR2: c_uint = 0002000;
    /// `CRDLY`: Carriage-return delay type 3.
    pub const CR3: c_uint = 0003000;
    ...
    pub const TABDLY: c_uint = 0014000;
    /// `TABDLY`: Horizontal-tab delay type 0.
    pub const TAB0: c_uint = 0000000;
    /// `TABDLY`: Horizontal-tab delay type 1.
    pub const TAB1: c_uint = 0004000;
    /// `TABDLY`: Horizontal-tab delay type 2.
    pub const TAB2: c_uint = 0010000;
    /// `TABDLY`: Horizontal-tab delay type 3.
    pub const TAB3: c_uint = 0014000;
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE` or `_XOPEN_SOURCE`]
    pub const BSDLY: c_uint = 0020000;
    /// Backspace-delay type 0.
    pub const BS0: c_uint = 0000000;
    /// Backspace-delay type 1.
    pub const BS1: c_uint = 0020000;

    /// Vertical tab delay mask.
    /// Values are [`VT0`](Self::VT0) or [`VT1`](Self::VT1).
    pub const VTDLY: c_uint = 0040000;
    /// `VTDLY`: Vertical-tab delay type 0.
    pub const VT0: c_uint = 0000000;
    /// `VTDLY`: Vertical-tab delay type 1.
    pub const VT1: c_uint = 0040000;

    /// Form feed delay mask.
    /// Values are [`FF0`](Self::FF0) or [`FF1`](Self::FF1).
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE` or `_XOPEN_SOURCE`]
    pub const FFDLY: c_uint = 0100000;
    /// `FFDLY`: Form-feed delay type 0.
    pub const FF0: c_uint = 0000000;
    /// `FFDLY`: Form-feed delay type 1.
    pub const FF1: c_uint = 0100000;

    /// See: [`TAB3`](Self::TAB3)
    pub const XTABS: c_uint = 0014000;
}
...
impl LINUX_TERMIOS_LFLAG {
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE` or `_XOPEN_SOURCE`]
    pub const XCASE: c_uint = 0000004;
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE`]
    pub const ECHOCTL: c_uint = 0001000;
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE`]
    pub const ECHOPRT: c_uint = 0002000;
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE`]
    pub const ECHOKE: c_uint = 0004000;
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE`]
    pub const FLUSHO: c_uint = 0010000;
    ...
    ///
    /// [requires `_BSD_SOURCE` or `_SVID_SOURCE`]
    pub const PENDING: c_uint = 0040000;
