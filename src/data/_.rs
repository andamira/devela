...
crate::mods_in! {
    pub mod_ access; // Mechanisms of reachability and traversal
    pub mod_ codec; // Data encoding and decoding abstractions
    pub mod_ id; // Identifiers and references for stable and contextual distinction
    pub mod_ history; // Origins and evolution of data across derivations and change
    pub mod_ layout; // Structural arrangement of elements in memory or sequence
    pub mod_ store; // Retained data stores and retrieval semantics
    pub mod_ topol; // Relational topology over structured data
