...
_reexport! { rust: core::iter, location: "data/access/iter", tag: _tags!(iterator no),
...
_reexport! { rust: core::iter, location: "data/access/iter", tag: _tags!(iterator logic),
...
_reexport! { rust: core::iter, location: "data/access/iter", tag: _tags!(iterator lifetime),
