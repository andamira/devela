// devela/src/data/store/key/map/_.rs
//
...
crate::mods_in! {
    ...
    mod_ fixed; // Fixed-capacity open-addressed hash maps with mutable entries
    // mod_ perfect; // Immutable perfect-hash maps over statically known key sets
}
