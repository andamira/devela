...
#[doc = crate::_doc_meta!{location("data/id", macro type_resource)}]
///
...
#[doc = crate::_doc_meta!{location("data/id", trait TypeResourced)}]
///
...
#[doc = crate::_doc_meta!{location("data/id", struct TypeResource)}]
///
/// # Examples
/// ```
/// # use devela::type_resource;
...
mod impls {
    ...
    macro_rules! _data_id_type_resource_impl_from {
        ($($t:ty),+) => { $( _data_id_type_resource_impl_from![@$t]; )+ };
        (@$t:ty) => {
    ...
    _data_id_type_resource_impl_from![
        bool, char,
