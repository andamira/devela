...
enumset! {
    #[doc = crate::_tags!(example bit mem data member)]
    /// An example enum, generated by [`enumset!`].
    #[doc = crate::_doc_meta!{
    ...
    pub enum EnumExample<'a, 'b, T>(
        ...
        #[doc = crate::_doc_meta!{
            location("data/codec/bin", struct EnumSetExample),
            test_size_of(EnumSetExample = 1|8; niche !Option),
        }]
