...
#![doc = crate::_doc!(hr)]
//!
//! Dynamically sized values are retained in storage whose capacity is supplied separately.
//!
//! This allows ownership without requiring heap allocation.
//!
#![doc = crate::_doc_warn_miri!(body, url: "https://github.com/thepowersgang/stack_dst-rs/issues/14")]
//!
...
//!
//! ## An unboxed any
//! The following example wraps a 64-bit integer up in an inline DST using the `Any` trait:
//!
//! ```rust
