// devela/src/data/layout/dst/queue/mod.rs
//
...
#[doc = crate::_doc_meta!{
    location("data/layout/dst", struct DstQueue),
}]
/// # Examples
/// ```
...
#[doc = crate::_doc_meta!{
    location("data/layout/dst", type DstQueueUsize),
}]
/// # Examples
/// ```
...
#[doc = crate::_doc_meta!{
    location("data/layout/dst", struct DstQueuePopGuard),
}]
#[derive(Debug)]
...
#[doc = crate::_doc_meta!{
    location("data/layout/dst", struct DstQueueIter),
}]
#[derive(Debug)]
...
#[doc = crate::_doc_meta!{
    location("data/layout/dst", struct DstQueueIterMut),
}]
#[derive(Debug)]
