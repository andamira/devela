...
mod data_types {
    ...
    #[doc = TAG_PRIMITIVE!()] /// A GLSL single-precision floating-point number.
    pub type g_float = f32;
    #[doc = TAG_PRIMITIVE!()] /// A GLSL double-precision floating-point number.
    pub type g_double = f64;

    #[doc = TAG_PRIMITIVE!()] /// A GLSL signed 32-bit integer.
    pub type g_int = i32;
    #[doc = TAG_PRIMITIVE!()] /// A GLSL unsigned 32-bit integer.
    pub type g_uint = u32;
