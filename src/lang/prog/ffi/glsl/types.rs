...
mod data_types {
    ...
    /// A GLSL boolean.
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", type g_bool),
    }]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", type g_float),
    }]
    pub type g_float = f32;
    #[doc = crate::_tags!(primitive num)]
    /// A GLSL double-precision floating-point number.
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", type g_double),
    }]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", type g_int),
    }]
    pub type g_int = i32;
    #[doc = crate::_tags!(primitive num)]
    /// A GLSL unsigned 32-bit integer.
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", type g_uint),
    }]
    pub type g_uint = u32;
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_bvec2),
    }]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_bvec3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_bvec4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_vec2),
    }]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_vec3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_vec4),
    }]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_dvec2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_dvec3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_dvec4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_ivec2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_ivec3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_ivec4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_uvec2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_uvec3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_uvec4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq, Eq, Hash)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat2x3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat2x4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat3x2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat3x4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat4x2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat4x3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_mat4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_dmat2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_dmat3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_dmat4),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_vertex2),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
    ...
    #[doc = crate::_doc_meta!{
        location("lang/prog/ffi/glsl", struct g_vertex3),
    }]
    #[repr(C)] #[derive(Clone, Copy, Debug, Default, PartialEq)]
