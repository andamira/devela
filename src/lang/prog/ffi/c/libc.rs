...
#[doc = crate::_doc_meta!{
    location("lang/ffi/c", type c_bool),
}]
...
#[doc = crate::_doc_meta!{
    location("lang/ffi/c", type c_mode_t),
}]
...
#[doc = crate::_doc_meta!{
    location("lang/ffi/c", type c_off_t),
}]
...
#[doc = crate::_doc_meta!{
    location("lang/ffi/c", type c_size_t),
}]
...
#[doc = crate::_doc_meta!{
    location("lang/ffi/c", type c_ssize_t),
}]
