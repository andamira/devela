...
/// # Examples
/// ```
/// use devela::ops::slice_into_array;
///
...
///
/// # Features
/// It makes use of the `unsafe_ops` feature if enabled.
///
...
/// # Examples
/// ```
/// use devela::ops::try_vec_into_vec;
///
...
/// # Examples
/// ```
/// use devela::ops::try_slice_into_vec;
///
