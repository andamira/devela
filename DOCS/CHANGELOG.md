...
- new types:
  ...
  - lang: `g_*`, `js_*`, `JsEvent`, `JsEventMouse`, `JsEventPointer`, `JsInstant`, `JsPermission`, `JsPermissionState`, `JsTextMetrics`, `JsTextMetricsFull`, `JsTimeout`, `JsWorker`, `JsWorkerError`, `JsWorkerJob`.
