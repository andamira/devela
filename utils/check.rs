...
const DEP_ALL: [&str; 33] = [
    ...
    "dep_miniquad", "dep_nanoserde", "dep_nc", "dep_portable_atomic", "dep_pyo3",
    "dep_rand_core", "dep_rayon", "dep_raw_cpuid", "dep_regex_lite", "dep_rodio",
    "dep_rustix", "dep_safe_arch", "dep_stringzilla", "dep_sysinfo", "dep_tinyaudio",
    "dep_tokio", "dep_tracing", "dep_unicode_segmentation", "dep_unicode_width",
