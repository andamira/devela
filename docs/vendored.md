...
- <i id="quickdiv"></i>[quickdiv] by Darko Trifunovski,
  as the [`divisor!`] macro ([*modifications*][M_quickdiv]).
...
[argv]: https://crates.io/crates/argv/0.1.13
  ...
  [`IterArgsOsRef`]: https://docs.rs/devela/latest/devela/sys/env/struct.IterArgsOsRef.html
  [`Env::args_os_ref`]: https://docs.rs/devela/latest/devela/sys/env/struct.Env.html#method.args_os_ref
...
[quickdiv]: https://crates.io/crates/quickdiv/0.1.1
  ...
  [`divisor!`]: https://docs.rs/devela/latest/devela/num/macro.divisor.html
[stack_dst]: https://crates.io/crates/stack_dst/0.8.1
  ...
  [`data::layout::dst`]: https://docs.rs/devela/latest/devela/data/layout/dst/index.html
...
- <i id="transliteration"></i>[transliteration] by *yf-hk*,
  as the [`Translit::ascii_scalar`] method.
...
[grapheme_machine]: https://crates.io/crates/grapheme_machine/0.2.0
  ...
  [`GraphemeMachine`]: https://docs.rs/devela/latest/devela/text/unicode/grapheme/struct.GraphemeMachine.html
  [`text::grapheme`]: https://docs.rs/devela/latest/devela/text/unicode/grapheme/
...
[transliteration]: https://github.com/yf-hk/transliteration/releases/tag/v2.6.1
  [`Translit::ascii_scalar`]: https://docs.rs/devela/latest/devela/text/Translit/method.ascii_scalar.html
