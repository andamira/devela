...
- update `Char`:
  ...
  - add methods: `decode_surrogate_pair`, `has_overlong_encoding`, `has_valid_continuation`, `is_surrogate*`, `is_utf8_boundary`, `to_char`, `to_char_lenient`, `to_char_unchecked`, `utf8_len_match`, `utf8_len_match_naive`.
