//
//! Docs headings for modules and misc. abbreviations.
//
// NOTES
...
";
    ...
    _DOC_DATA               = "Structural organization of data before domain-specific interpretation.";
    _DOC_DATA_ACCESS         = "Reachability and traversal over externally supplied data.";
    ...
    _DOC_DATA_ACCESS_ITER    = "Iteration protocols for successive and lending traversal.";
    _DOC_DATA_ACCESS_ROUTE   = "Ordered reachability expressed as uninterpreted segments.";
    _DOC_DATA_CODEC         = "Transformations between and over data representations.";
    _DOC_DATA_CODEC_BIN     = "Binary representation primitives and compact structural encodings.";
    _DOC_DATA_CODEC_BIN_BIT = "Bit-level sets, fields, and compact structures.";
    _DOC_DATA_CODEC_CRYPTO  = "Cryptographic transforms, digests, authentication, and related codes.";
    ...
    _DOC_DATA_CODEC_HASH    = "Hashing contracts and compact fingerprints over data.";
    _DOC_DATA_CODEC_INTEGRITY = "Checksums and codes for detecting representation corruption.";
    _DOC_DATA_CODEC_PACK    = "Packed, compressed, and container representations.";
    _DOC_DATA_CODEC_SYMBOL  = "Mappings between data and structured visual symbols.";
    _DOC_DATA_HISTORY       = "Relations between data and its antecedents across change.";
    _DOC_DATA_HISTORY_REL   = "Historical relations between data and its antecedents.";
    _DOC_DATA_ID            = "Identity forms with explicit scope and resolution semantics.";
    _DOC_DATA_ID_HANDLE     = "Compact references whose meaning and validity come from a resolver.";
    _DOC_DATA_ID_LOCAL      = "Identity scoped to a local allocator, registry, address, or type context.";
    _DOC_DATA_ID_UUID       = "Standardized portable 128-bit identities across contexts.";
    _DOC_DATA_LAYOUT        = "Physical and logical arrangement of values within storage.";
    _DOC_DATA_LAYOUT_ARRAY  = "Contiguous homogeneous storage with dimensional projections.";
    _DOC_DATA_LAYOUT_BUFFER = "Bounded storage with explicit capacity, occupancy, and ordering.";
    _DOC_DATA_LAYOUT_DST    = "Dynamically sized values retained without requiring heap allocation.";
    _DOC_DATA_LAYOUT_LINKED = "Sequential structures whose order is represented by explicit links.";
    ...
    _DOC_DATA_LAYOUT_TABLE  = "Two-dimensional layouts interpreted as rows, columns, and cells.";
    _DOC_DATA_STORE         = "Retention, lookup, reclamation, and reuse of stored values.";
    ...
    _DOC_DATA_STORE_INTERN  = "Canonical retention of equal values under shared identities.";
    _DOC_DATA_STORE_KEY     = "Storage and lookup organized by keys or membership.";
    _DOC_DATA_STORE_KEY_MAP = "Key-value stores organized by lookup and storage strategy.";
    _DOC_DATA_STORE_KEY_SET = "Membership stores organized by lookup and storage strategy.";
    _DOC_DATA_STORE_POOL    = "Reusable stores with independently reclaimable values and generational identity.";
    _DOC_DATA_TOPOL         = "Structural relations independent of value storage and geometry.";
    ...
    _DOC_DATA_TOPOL_ORD     = "Order as a structural relation.";
    _DOC_DATA_TOPOL_SPATIAL = "Locality, neighborhood, and partitioning over indexed domains.";
    _DOC_DATA_VALUE         = "Semantic forms of data independent of storage and canonical representation.";
    ...
    _DOC_GEOM_FIG_CURVE       = "One-dimensional geometric figures and paths.";
    _DOC_GEOM_FIG_CURVE_LINE  = "Linear geometric primitives such as segments and rays.";
    ...
    _DOC_SYS_HW_PIN           = "Pin-level hardware interfaces and signal buses.";
