...
/// Private API of [`bound_int`][crate::bound_int].
#[doc(hidden)]
#[macro_export]
macro_rules! __bound_int· {
    ...
    (%dispatch_carrier
        ...
        $crate::__bound_int!(%validate_range
    ...
    (%validate_range
        ...
        $crate::__bound_int!(%validate_range_backend
            attrs[$($attr)*] vis[$vis] name[$Name] repr[$Repr]
    ...
    (%emit_user_impls
        ...
        $(#[$impl_attr])*
        impl $Name { $($user_impl)* }
        $crate::__bound_int!(%emit_user_impls $Name; $($rest)*);
    };
...
#[doc(hidden)]
pub use __bound_int· as __bound_int;
