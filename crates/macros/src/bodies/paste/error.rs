// devela_macros::bodies::paste::error
//
...
pub(crate) type PasteResult<T> = core::result::Result<T, PasteError>;

pub(crate) struct PasteError {
    begin: Span,
    end: Span,
    msg: String,
}
...
impl PasteError {
    ...
    pub fn new2(begin: Span, end: Span, msg: &str) -> Self {
        Self { begin, end, msg: msg.to_owned() }
    }
