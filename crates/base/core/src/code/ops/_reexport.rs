...
use crate::{
    _TAG_CODE, _TAG_GUARD, _TAG_LIFETIME, _TAG_LOGIC, _TAG_NUM, _TAG_QUANT, _TAG_VALUE, _reexport,
};
...
_reexport! { rust: core::ops, location: "code/ops", tag: _TAG_CODE!(),
...
// num ops
_reexport! { rust: core::ops, location: "code/ops", tag: _TAG_NUM!(),
...
_reexport! { rust: core::ops, location: "code/ops", tag: _TAG_LIFETIME!(),
...
_reexport! { rust: core::ops, location: "code/ops", tag: _TAG_GUARD!(),
...
_reexport! { rust: core::ops, location: "code/ops", tag: _TAG_VALUE!() _TAG_LIFETIME!(),
