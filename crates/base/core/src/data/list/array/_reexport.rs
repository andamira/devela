// devela_base_core::data::list::array::_reexport

use crate::{_TAG_DATA_STRUCTURE, _TAG_ITERATOR, _reexport};

_reexport! { rust: core::array, location: "data/list/array", tag: _TAG_ITERATOR!(),
    doc: "A by-value [array] iterator.",
    @IntoIter as ArrayIntoIter
}
_reexport! { rust: core::array, location: "data/list/array", tag: _TAG_DATA_STRUCTURE!(),
